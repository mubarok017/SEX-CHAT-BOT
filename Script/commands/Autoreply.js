...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "👍": "জান ইনবক্সে কল দাও নিঃশ্বাস নিতে কষ্ট হচ্ছে ",
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ 𝚂𝚄𝙷𝙰𝙽 𝙰𝙷𝙼𝙴𝙳 ☜\nFacebook: https://www.facebook.com/SUHAN.VAI33\nWhatsApp: +8801933699293",
    "admin": "He is 𝚂𝚄𝙷𝙰𝙽 তাকে সবাই Admin হিসেবে চিনে😘☺️",
    ...
    "i love you": "মেয়ে হলে আমার বস সুহান এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss সুহান এর ইনবক্সে গুতা দিন 😘",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌𝚂𝚄𝙷𝙰𝙽 𝙲𝙷𝙰𝚃 𝙱𝙾𝚃💖",
    ...
    "ki koros": "বস সুহান এর সাথে প্রেমে ব্যস্ত আছি 😏💘",
    ...
    "breakup": "চিন্তা করিস না… সুহান বস তো আছেই তোকে নতুন জন দিয়া দিবে 😎🔥",
    "tui ke": "আমি তোর বস 𝚂𝚄𝙷𝙰𝙽 এর ChatBot 😏",
